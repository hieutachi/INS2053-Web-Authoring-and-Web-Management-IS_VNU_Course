// Estimate the rendered width of every <text> in a canvas file and flag any that
// would spill outside its viewBox. Catches the one defect a bracket check cannot:
// a label that is simply too long for the 560-wide diagram it lives in.
const fs = require("fs");
