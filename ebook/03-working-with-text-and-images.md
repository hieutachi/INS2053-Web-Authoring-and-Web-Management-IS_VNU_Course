...
## 🏠 HOMEWORK & SUBMISSION — Session 3

After class, this session has exactly one deliverable set: **Homework 03**.
Everything you need sits on one page — the task list, the video brief and the
reference rubric: [homework/session-03/homework.md](../homework/session-03/homework.md).
...
2. **Explain — Part 2 (video, 4 points).** Record a **60–120 second** OBS
   screen recording presenting ONE part of this homework — for example: show one image added to the gallery in your About page and explain what the `src`, `alt` and width/height attributes each do.
