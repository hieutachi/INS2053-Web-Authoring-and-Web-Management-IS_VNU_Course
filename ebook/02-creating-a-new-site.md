...
## 🏠 HOMEWORK & SUBMISSION — Session 2

After class, this session has exactly one deliverable set: **Homework 02**.
Everything you need sits on one page — the task list, the video brief and the
reference rubric: [homework/session-02/homework.md](../homework/session-02/homework.md).
...
2. **Explain — Part 2 (video, 4 points).** Record a **60–120 second** OBS
   screen recording presenting ONE part of this homework — for example: show your project folder tree and explain why the site lives in `project/` and the homework in `homework/session-02/`, and what each subfolder (`css/`, `images/`) is reserved for.
