...
## 🏠 HOMEWORK & SUBMISSION — Session 7

After class, this session has exactly one deliverable set: **Homework 07**.
Everything you need sits on one page — the task list, the video brief and the
reference rubric: [homework/session-07/homework.md](../homework/session-07/homework.md).
...
2. **Explain — Part 2 (video, 4 points).** Record a **60–120 second** OBS
   screen recording presenting ONE part of this homework — for example: show the Google Fonts `<link>` in your `<head>` and the `font-family` rules in CSS, and explain how you picked and paired the two fonts.
