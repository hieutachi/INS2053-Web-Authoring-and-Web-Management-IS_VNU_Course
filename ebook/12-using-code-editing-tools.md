...
## 🏠 HOMEWORK & SUBMISSION — Session 12

After class, this session has exactly one deliverable set: **Homework 12**.
Everything you need sits on one page — the task list, the video brief and the
reference rubric: [homework/session-12/homework.md](../homework/session-12/homework.md).
...
2. **Explain — Part 2 (video, 4 points).** Record a **60–120 second** OBS
   screen recording presenting ONE part of this homework — for example: show one HTML validation error and one CSS warning from the W3C validators and explain what caused them and how you fixed them.
