...
## 🏠 HOMEWORK & SUBMISSION — Session 11

After class, this session has exactly one deliverable set: **Homework 11**.
Everything you need sits on one page — the task list, the video brief and the
reference rubric: [homework/session-11/homework.md](../homework/session-11/homework.md).
...
2. **Explain — Part 2 (video, 4 points).** Record a **60–120 second** OBS
   screen recording presenting ONE part of this homework — for example: show your `README.md` and favicon, and explain what each README section promises a visitor and how the favicon is wired into the pages.
