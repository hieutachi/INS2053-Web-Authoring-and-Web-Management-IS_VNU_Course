...
## 🏠 HOMEWORK & SUBMISSION — Session 15

After class, this session has exactly one deliverable set: **Homework 15**.
Everything you need sits on one page — the task list, the video brief and the
reference rubric: [homework/session-15/homework.md](../homework/session-15/homework.md).
...
2. **Explain — Part 2 (video, 4 points).** Record a **60–120 second** OBS
   screen recording presenting ONE part of this homework — for example: show your site in the browser device toolbar, narrow the viewport live, and explain which media query rule fires and what it changes.
